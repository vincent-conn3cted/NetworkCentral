...
@UrlBinding("/reports/StaffSearchResultsReport-MailMerge.xls")
public class MailMergeStaffSearchResultsReportActionBean extends AbstractStaffSearchReportActionBean
{
    @SpringBean
    private AppointmentSearchResultsReportService searchResultsReportService;
    ...
    public Resolution export()
    {
    	if(null != getSearchReq() && getContext() != null && getContext().getUserRole() != null){  	
	        final ByteArrayOutputStream byteArrayOutputStream = searchResultsReportService.exportMailMerge(getSearchReq(), getContext().getUserRole());
