...
<script type="text/javascript">
    ...
    {
        location.href = '<stripes:url beanclass="au.com.toyota.nc.webapp.stripes.staff.DealerStaffSearchActionBean" event="displaySearchPage" />';
    }

    function loadSavedSearchPage()
    {
        location.href = '<stripes:url beanclass="au.com.toyota.nc.webapp.stripes.staff.DealerStaffSearchActionBean" event="displaySavedSearches" />&searchEventName=' + '${param['searchEventName']}';
    }
</script>
