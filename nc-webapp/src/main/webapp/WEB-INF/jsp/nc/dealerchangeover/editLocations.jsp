...
<stripes:layout-render name="/WEB-INF/jsp/layout/stdLayout.jsp">
    <stripes:layout-component name="html-head">
         <link rel="stylesheet" media="screen" type="text/css" href="${pageContext.request.contextPath}/css/wib/changeOver/nc-changeOver.css"/>
                ...
                <stripes:form beanclass="au.com.toyota.nc.webapp.stripes.dealerchangeover.ProcessDealerChangeoverActionBean">
                    ...
                    <table id="changeOverTable-locations"class="resultsTable">
                        ...
                        <tbody>
                            ...
                            <c:forEach items="${actionBean.dealerChangeover.oldDealer.activeNonPrincipalLocations}" var="location" varStatus="loopStatus">
                                <tr class="${loopStatus.index %2==0 ? 'darkRow':'lightRow'}">
                                    ...
                                    <td>
                                        <div class="data-line"><stripes:checkbox name="selectedLocationIds" value="${location.locationId}" checked="selectedLocationIds"/></div>
                                    </td>
                                </tr>
                            </c:forEach>
                        </tbody>
                     ...
                     <div class="formActionButtons">
                         ...
                         <stripes:submit name="saveEditLocations" value="Save and Continue" id="saveLocationsButton" class="btn btn_saveContinue"/>
                        <div class="clear"></div>
                    </div>
