...
public class AddStaffAgreementActionBean extends BaseActionBean
{
    @SpringBean
...
*/
    ...
    @HandlesEvent("showAddStaffAgreement")
    public Resolution showAddStaffAgreement()
    {
        return new ForwardResolution(JSP_BASE + "/savedsearch/locationSaveSearchLabel.jsp");
    }
    @HandlesEvent("checkAgreement")
    public Resolution checkAgreement()
    {
        return new ForwardResolution(JSP_BASE + "/savedsearch/locationSaveSearchLabel.jsp");
    }
