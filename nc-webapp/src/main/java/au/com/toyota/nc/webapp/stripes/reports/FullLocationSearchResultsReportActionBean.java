 ...
 * Time: 13:59:50
 */
@UrlBinding("/reports/LocationSearchResultsReport-Full.xls")
public class FullLocationSearchResultsReportActionBean extends BaseActionBean
{
    @SpringBean
    ...
    {
        final ByteArrayOutputStream byteArrayOutputStream = searchResultsReportService.exportFullReport(searchReq, getContext().getUserRole());
